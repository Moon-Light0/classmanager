    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li id="admin-index"><a href="${pageContext.request.contextPath}/student/getByStuNo?stuNo=${user.stuNo}"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown tasks-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <c:if test="${user.stuId != '1'}">
                                    <span class="label label-danger" id="taskNum">${user.isTodaySign==1?'1':''}</span>
                                </c:if>
                            </a>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">${user.stuName}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                        ...
                        <div class="box-body" >
                            <c:if test="${user.stuId != '1'}">
                                ...
                                <div class="dropdown" style="display: inline-block">
                                    ...
                                    <ul class="dropdown-menu" style="min-width:100px">
                                        <c:forEach var="queqin" items="${user.eveningStudies}">
                                            <c:if test="${queqin.isSign==0}">
                                                <li style="font-size: 12px">${queqin.eDateStr}</li>
                                            </c:if>
                                        </c:forEach>
                                        <li role="separator" class="divider"></li>
                                        <li><span class="label label-info" id="queqin">${user.eveningStudies.size()-user.comeNum}</span></li>
                                    </ul>
                                </div>
                                </p>
                                <hr>
                          ...
                          3 Jan. 2014
                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="inputExperience" class="col-sm-2 control-label">性别</label>
